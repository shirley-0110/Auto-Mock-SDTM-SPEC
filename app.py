...
def build_ts_template_rows(
    ...
    refver_map = {
        ...
        "HLTSUBJI": ("CDISC CT", ct_ver),
        "INTMODEL": ("CDISC CT", ct_ver),
        "INTTYPE": ("CDISC CT", ct_ver),
        "ONGOSIND": ("CDISC CT", ct_ver),
        "PDPSTIND": ("CDISC CT", ct_ver),
        "PDSTIND": ("CDISC CT", ct_ver),
        "PIPIND": ("CDISC CT", ct_ver),        
        "RANDOM": ("CDISC CT", ct_ver),
        "RDIND": ("CDISC CT", ct_ver),
        "SEXPOP": ("CDISC CT", ct_ver),
        "STYPE": ("CDISC CT", ct_ver),
        "TBLIND": ("CDISC CT", ct_ver),
        "TCNTRL": ("CDISC CT", ct_ver),
        "TINDTP": ("CDISC CT", ct_ver),
        "TPHASE": ("CDISC CT", ct_ver),
        "TTYPE": ("CDISC CT", ct_ver),
